...
export const LeaveAReview:React.FC<{submitReview:any}> = (props) =>{
    ...
    return(
        ...
        <div className="dropdown" style={{cursor:'pointer'}}>
            <h5 className="dropdown-toggle id='dropdownMenueButton1" data-bs-toggle='dropdown'>
                Leave a review ?
            </h5>
            <ul id="submitReviewRating" className="dropdown-menu" aria-labelledby="dropdownMenueButton1">
