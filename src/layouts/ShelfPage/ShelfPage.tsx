            ...
            <div className="mt-3">
                <nav>
                    <div className="nav nav-tabs" id='nav-tabs' role='tablist'>
                        <button onClick={() => setHistoryClick(false)} 
                            className="nav-link active" id='nav-loans-tab' data-bs-toggle='tab'
                        ...
                        <button  onClick={() => setHistoryClick(true)} 
                            className="nav-link" id='nav-history-tab' data-bs-toggle='tab'
